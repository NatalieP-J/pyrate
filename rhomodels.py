...
class NukerModelGenRho:
    ...
    def getrho(self,rtest = 0):
        ...
        if self.generate == True:
            tab1 = self.funcrho(rtest1)
            tab2 = abs(self.funcdrhodr(rtest1))
            tab3 = abs(self.funcd2rhodr2(rtest1))
            inter0 = interp1d(log10(rtest1),log10(tab1))
            inter1 = interp1d(log10(rtest1),log10(tab2))
            inter2 = interp1d(log10(rtest1),log10(tab3))
